...
class Stage {
    ...
    doAttack(attacking, attacked) {
        ...
        let actaulAttack = attacking.attack * attackFactor
        let attualDefense = attacking.defense * defenseFactor

        if (actaulAttack >= attualDefense) {
            attacked.life -= actaulAttack
            this.log.addMessage(`${attacking.name} causou ${actaulAttack.toFixed(2)} de dano em 
            ${attacked.name}`) 
        }
        else {
